...
normalBalon_sound = pygame.mixer.Sound("sesler/yt5s.io - Balloon Pop Sound effect (320 kbps).mp3")
siyahBalon_sound = pygame.mixer.Sound("sesler/yt5s.io - Breaking glass sound effect (320 kbps).mp3")
